...
export const TOOLS = [
    {
        name: 'authenticate',
        description: 'Authenticate with the Expense Tracker API using user credentials (email & password) to generate a valid session token for subsequent actions.',
        inputSchema: {
            type: 'object',
            properties: {
                email: {
    ...
    },
    {
        ...
        description: 'Retrieve information about the currently authenticated user (ID, email, name, role, status).',
        inputSchema: {
            type: 'object',
            properties: {},
        },
    ...
    {
        name: 'list_expenses',
        description: 'Query and list expenses with optional filters for category, date range (start_date, end_date), or specific user ID (admin only).',
        inputSchema: {
            type: 'object',
            properties: {
                category: {
    ...
    {
        name: 'create_expense',
        description: 'Create and record a new expense item with amount, description, category, and date.',
        inputSchema: {
            type: 'object',
            properties: {
                amount: {
    ...
    {
        name: 'get_summary',
        description: 'Retrieve aggregated spending summary including total amount, expense count, and category breakdown for a given date range.',
        inputSchema: {
            type: 'object',
            properties: {
                start_date: {
    ...
    {
        name: 'get_insights',
        description: 'Retrieve AI-powered financial intelligence including safe daily spend, month-end projection, burn rate status, 50/30/20 budget breakdown, and tailored saving recommendations.',
        inputSchema: {
            type: 'object',
            properties: {
                monthly_budget: {
