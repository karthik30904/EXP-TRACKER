...
export const PROMPTS = [
    {
        ...
        description: 'Perform a deep-dive analysis of user expenses, category breakdown, burn rate status, and actionable recommendations to cut costs.',
        arguments: [
            {
                name: 'focus_category',
    ...
    {
        name: 'audit_expenses',
        description: 'Audit recent expenses to detect anomalies, duplicate charges, unusual spikes, or recurring subscriptions.',
        arguments: [
            {
                name: 'days_to_audit',
